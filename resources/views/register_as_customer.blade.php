		...
		<div class="w-full md:w-1/2 bg-gray-100 flex flex-col px-12 py-10">
			...
			<div class="flex-block">
				<form action="/register" method="POST">
					...
					<a href="/auth/google" class="flex w-full py-3 rounded-lg border border-gray-300 bg-white hover:bg-gray-50 flex items-center justify-center gap-3 text-sm font-medium text-gray-700 transition-colors mb-4">
